...
public class agentChangeMobileBN extends JFrame {
    ...
    public agentChangeMobileBN(String mobile) {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String query1 = "UPDATE agent_info SET MOBILE = '" + label8Text.getText() + "' WHERE MOBILE = '" + mobile + "'" ;
                try {
