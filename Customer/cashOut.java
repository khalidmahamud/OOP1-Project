...
public class cashOut extends JFrame {
    ...
    cashOut(String mobile) {
        ...
        recipientMSG.setText("Enter 11-digit Mobile Number");
        ...
        recipientPassLabel = new JLabel("Password");
        ...
        nextButton2.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                    if(password.equals(new String(recipientPass.getPassword())))
                    {
                        ...
                        confirmCashOut confirm = new confirmCashOut(mobile, newBalance, recipientText.getText(), Double.parseDouble(amountText.getText()));
                        setVisible(false);
...
//              setVisible(false);
        ...
        backButton.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                HomePage send = new HomePage(mobile);
