...
public class agentChangeFNameBN extends JFrame {
    ...
    public agentChangeFNameBN (String mobile) {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (error != null) {
                    ...
                    String query1 = "UPDATE agent_info SET FIRSTNAME = '" + label1Text.getText() + "' WHERE MOBILE = '" + mobile + "'" ;
                    try {
