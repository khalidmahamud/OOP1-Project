...
public class agentSendMoney extends JFrame {
        ...
        nextButton2.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                if(password.equals(new String(recipientPass.getPassword())))
                {
                    ...
                    agentConfirmTrans confirm = new agentConfirmTrans(mobile, newBalance, recipientText.getText(), Double.parseDouble(amountText.getText()));
                    setVisible(false);
...
//              setVisible(false);
        ...
        setTitle("Agent Send Money"); //title
