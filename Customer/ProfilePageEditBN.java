...
public class ProfilePageEditBN extends JFrame {
    ...
    public JButton passChange;
    Icon homeIcon, menuIcon, sendIcon, cashIcon;
    JLabel passChangeLabel1, passChangeLabel2, proLabel;
    ...
    public ProfilePageEditBN (String mobile) {
        ...
        genderChange.setToolTipText("Change Gender");
        ...
        passChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                ChangeProPassBN change =  new ChangeProPassBN(mobile);
        ...
        fnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeFNameBN change =  new changeFNameBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        lnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeLNameBN change =  new changeLNameBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        emailChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeEmailBN change =  new changeEmailBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        mobileChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeMobileBN change =  new changeMobileBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        genderChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeGenderBN change =  new changeGenderBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        dobChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                changeDOBBN change =  new changeDOBBN(mobile);
                change.setVisible(true);
             } 
        });
        ...
        button3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {       
                ...
                MenuPageBN menu = new MenuPageBN(mobile);
