...
public class agentChangeEmailBN extends JFrame {
    ...
    public agentChangeEmailBN (String mobile) {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (error != null) {
                    ...
                    String query1 = "UPDATE agent_info SET EMAIL = '" + label3Text.getText() + "' WHERE MOBILE = '" + mobile + "'" ;
                    try {
