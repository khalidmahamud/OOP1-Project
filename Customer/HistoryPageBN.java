...
public class HistoryPageBN extends JFrame {
    ...
    HistoryPageBN(String mobile) {
        ...
        button2.addMouseListener(new MouseListener() {
            @Override
            public void mouseEntered(MouseEvent e) {
              button2.setBackground(new Color(0, 59, 87));
            }
            @Override
            public void mouseExited(MouseEvent e) {
              button2.setBackground(new Color(0, 87, 117));
        ...
        try {
            ...
            transTable.getColumnModel().getColumn(2).setPreferredWidth(25);
