...
public class agentMenuPageBN extends JFrame {
    ...
    public agentMenuPageBN (String mobile) {
...
//                setVisible(false);
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                agentProfilePageBN profile1 = new agentProfilePageBN(mobile);
...
//                setVisible(false);
        ...
        langB.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                //Language Page
                agentMenuLanguageBN language =  new agentMenuLanguageBN (mobile);
...
//                setVisible(false);
        ...
        supB.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                //About Page
                agentAboutUsBN about=new agentAboutUsBN(mobile);
