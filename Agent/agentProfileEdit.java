...
public class agentProfileEdit extends JFrame {
    ...
    public agentProfileEdit (String mobile) {
        ...
        passChangeLabel1 = new JLabel("Change");
        passChangeLabel1.setBounds(38, 30, 100, 18);
        ...
        passChangeLabel2 = new JLabel("Password");
        passChangeLabel2.setBounds(31, 49, 100, 18);
        ...
        passChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeProPass change =  new agentChangeProPass(mobile);
        ...
        fnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeFName change =  new agentChangeFName(mobile);
                change.setVisible(true);
            }
        });
        ...
        lnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeLName change =  new agentChangeLName(mobile);
                change.setVisible(true);
            }
        });
        ...
        emailChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeEmail change =  new agentChangeEmail(mobile);
                change.setVisible(true);
            }
        });
        ...
        mobileChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeMobile change =  new agentChangeMobile(mobile);
                change.setVisible(true);
            }
        });
        ...
        genderChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeGender change =  new agentChangeGender(mobile);
                change.setVisible(true);
            }
        });
        ...
        dobChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeDOB change =  new agentChangeDOB(mobile);
                change.setVisible(true);
            }
        });
