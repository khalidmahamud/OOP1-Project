...
public class addMoneyBN extends JFrame {
    ...
    public addMoneyBN(String mobile) {
        ...
        addMSG = new JLabel("সঠিক রিচার্জ কোড প্রবেশ করান");
            ...
            public void actionPerformed (ActionEvent e) {
                if (password.equals(new String(addMonPass.getPassword()))) {
                    ...
                    try {
                        ...
                        String query2 = "UPDATE account SET BALANCE = '" + newBalance + "' WHERE MOBILE = '" + mobile + "'" ;
