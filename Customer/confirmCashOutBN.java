...
public class confirmCashOutBN extends JFrame {
    ...
    public confirmCashOutBN (String mobile, double newBalance, String recMobile, double amount) {
        this.mobile = mobile;
        ...
        //database connection
        String query3 = "SELECT * FROM agentAccount WHERE MOBILE = '" + recMobile + "'" ;
        try {
        ...
        recipientLabel = new JLabel("এজেন্ট");
        ...
        newBalanceLabel = new JLabel("নতুন ব্যালেন্স");
        ...
        confirmButton.setFont(new Font("Potro Sans Bangla", Font.PLAIN, 22));
        ...
        confirmButton.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                ...
                String query2 = "UPDATE agentAccount SET BALANCE = '" + newRecBalance + "' WHERE MOBILE = '" + recMobile + "'" ;
                ...
                String email1 = "Cash Out Tk " + amount + " is successful, Agent Account: " + recMobile + ", Your A/C Balance: Tk " + newBalance + ", Date: " + getDateTime();
                        sendEmail(email1, "Cash Out");
                
                JOptionPane.showMessageDialog(null, "Cash Out is Successful.", "Success", 2);
