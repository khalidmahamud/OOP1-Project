...
//                setVisible(false);
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {       
                ...
                ProfilePage profile1 = new ProfilePage(mobile);
...
//                setVisible(false);
        ...
        langB.addActionListener(new ActionListener() {
               public void actionPerformed(ActionEvent e) {
                   ...
                   //Language Page
			       Language language =  new Language(mobile);
...
//                setVisible(false);
        ...
        supB.addActionListener(new ActionListener() {
               public void actionPerformed(ActionEvent e) {
                    AboutUs about = new AboutUs(mobile);
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing (WindowEvent e) {
                ...
                if (result == JOptionPane.NO_OPTION) {
                    ...
                    File folder = new File("D:\\Java Projects\\GUI Project\\Experimen\\Customer");
