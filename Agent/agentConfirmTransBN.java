...
public class agentConfirmTransBN extends JFrame {
    ...
    public agentConfirmTransBN (String mobile, double newBalance, String recMobile, double amount) {
        this.mobile = mobile;
        ...
        amountLabel.setBounds(75, 145, 100, 22);
