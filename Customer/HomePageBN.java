...
public class HomePageBN extends JFrame {
    ...
    HomePageBN(String mobile) {
        ...
        balButton.setFont(new Font("Potro Sans Bangla", Font.PLAIN, 22));
        ...
        sendLabel = new JLabel(new ImageIcon("Pictures\\sendMoney.png"));
        sendLabel.setText("সেন্ড মানি");
        sendLabel.setBounds(13, 14, 100, 100);
        sendLabel.setFont(new Font("Potro Sans Bangla", Font.PLAIN, 17));
        sendLabel.setForeground(Color.white);
        sendLabel.setHorizontalTextPosition(JButton.CENTER);
        sendLabel.setVerticalTextPosition(JButton.BOTTOM);
        sendLabel.setIconTextGap(2);
        ...
        sendButton.addActionListener(new ActionListener() {
         ...
         addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {       
                ...
                addMoneyBN add = new addMoneyBN(mobile);
        ...
        cashOutButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {       
                ...
                cashOutBN cash_out = new cashOutBN(mobile);
