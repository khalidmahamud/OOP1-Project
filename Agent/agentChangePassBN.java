...
public class agentChangePassBN extends JFrame {
    ...
    public agentChangePassBN() {
        ...
        userText.setText("মোবাইল নম্বর");
        userText.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (userText.getText().equals("মোবাইল নম্বর")) {
                    userText.setText("");
                }
            }
        ...
        label7Pass.setText("নতুন পাসওয়ার্ড");
        label7Pass.setEchoChar((char) 0);
        label7Pass.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (new String(label7Pass.getPassword()).equals("নতুন পাসওয়ার্ড")) {
        ...
        labelConPass.setText("নতুন পাসওয়ার্ড নিশ্চিত করুন");
        labelConPass.setEchoChar((char) 0);
        labelConPass.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (new String(labelConPass.getPassword()).equals("নতুন পাসওয়ার্ড নিশ্চিত করুন")) {
        ...
        showButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (new String(label7Pass.getPassword()) != "নতুন পাসওয়ার্ড") {
                    label7Pass.setEchoChar((char) 0);
        ...
        showButton1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (new String(labelConPass.getPassword()) != "নতুন পাসওয়ার্ড নিশ্চিত করুন") {
                    labelConPass.setEchoChar((char) 0);
        ...
        //signup button
        nextButton = new RoundJButton(120);
        ...
        JLabel otpLabel = new JLabel("ওটিপি");
        ...
        //back
        backButton1 = new JButton("ফিরে যান");
        ...
        nextButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String error = errorMsg(userText.getText());
                if (error != null) {
                    JOptionPane.showMessageDialog(null, error, "Warning", 2);
                }
                else {
                    //database connection
                String query = "SELECT * FROM agent_info WHERE MOBILE = '" + userText.getText() + "'" ;
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (otpText.getText().equals(Integer.toString(random))) {
                    String query1 = "UPDATE agent_info SET PASSWORD = '" + new String(label7Pass.getPassword()) + "' WHERE MOBILE = '" + userText.getText() + "'" ;
                    try {
                    ...
                    agentLoginBN login = new agentLoginBN();
                    dispose();
    ...
    public static String errorMsg(String recMobile) {
        String query2 = "SELECT * FROM agent_info WHERE MOBILE = '" + recMobile + "'";
        try {
