...
public class agentConfirmTrans extends JFrame {
    ...
    public agentConfirmTrans (String mobile, double newBalance, String recMobile, double amount) {
        this.mobile = mobile;
        ...
        backButton.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                agentSendMoney send = new agentSendMoney(mobile);
