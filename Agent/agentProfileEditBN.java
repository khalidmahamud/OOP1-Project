...
public class agentProfileEditBN extends JFrame {
    ...
    public JButton passChange, cashOutButton, rechargeButton, addButton;
    Icon homeIcon, menuIcon, sendIcon, cashIcon;
    JLabel passChangeLabel1, passChangeLabel2, rechargeLabel, addLabel, proLabel;
    ...
    public agentProfileEditBN (String mobile) {
        ...
        dobLabel = new JLabel("জন্ম তারিখ");
        ...
        passChange = new RoundJButton(130);
        passChange.setLocation(40, 200);
        passChange.setSize(130, 80);
        passChange.setBackground(new Color(0, 59, 79));
        passChange.setLayout(null);
        passChange.setFocusPainted(false);
        sendIcon = new ImageIcon("Pictures\\cngpass.png");
        passChange.setHorizontalAlignment(JButton.CENTER);
        passChange.setVerticalAlignment(JButton.TOP);
        passChange.setIcon(sendIcon);
        proPanel.add(passChange);
        passChangeLabel1 = new JLabel("পাসওয়ার্ড");
        passChangeLabel1.setBounds(38, 32, 100, 18);
        passChangeLabel1.setFont(new Font("Potro Sans Bangla", Font.PLAIN, 17));
        passChangeLabel1.setFocusable(false);
        passChangeLabel1.setForeground(Color.white);
        passChange.add(passChangeLabel1);
        passChangeLabel2 = new JLabel("পরিবর্তন");
        passChangeLabel2.setBounds(41, 54, 100, 18);
        passChangeLabel2.setFont(new Font("Potro Sans Bangla", Font.PLAIN, 17));
        passChangeLabel2.setFocusable(false);
        passChangeLabel2.setForeground(Color.white);
        passChange.add(passChangeLabel2);
        passChange.addMouseListener(new MouseListener() {
            @Override
            public void mouseEntered(MouseEvent e) {
              passChange.setBackground(new Color(0, 87, 117));
            }
            @Override
            public void mouseExited(MouseEvent e) {
              passChange.setBackground(new Color(0, 59, 79));
        ...
        //password chnage button
        passChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            
                dispose();
                agentChangeProPassBN change =  new agentChangeProPassBN(mobile);
        ...
        fnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeFNameBN change =  new agentChangeFNameBN (mobile);
                change.setVisible(true);
            }
        });
        ...
        lnameChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeLNameBN change =  new agentChangeLNameBN(mobile);
                change.setVisible(true);
            }
        });
        ...
        emailChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeEmailBN change =  new agentChangeEmailBN (mobile);
                change.setVisible(true);
            }
        });
        ...
        mobileChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeMobileBN change =  new agentChangeMobileBN (mobile);
                change.setVisible(true);
            }
        });
        ...
        genderChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeGenderBN change =  new agentChangeGenderBN (mobile);
                change.setVisible(true);
            }
        });
        ...
        dobChange.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dispose();
                agentChangeDOBBN change =  new agentChangeDOBBN (mobile);
                change.setVisible(true);
            }
        });
