...
public class agentSignUp extends JFrame {
    ...
    public agentSignUp() {
        ...
        label = new JLabel("Agent Sign Up");
        label.setFont(new Font("Potro Sans Bangla", Font.BOLD, 30));
        ...
        label1Text.setText("First Name");
        label1Text.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (label1Text.getText().equals("First Name")) {
                    label1Text.setText("");
                }
            }
        ...
        label2Text.setText("Last Name");
        label2Text.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (label2Text.getText().equals("Last Name")) {
                    label2Text.setText("");
                }
            }
        ...
        label3Text.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (label3Text.getText().equals("Email")) {
                    label3Text.setText("");
                }
            }
        ...
        label6Text.setText("Nationality");
        label6Text.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (label6Text.getText().equals("Nationality")) {
                    label6Text.setText("");
                }
            }
        ...
        label7Pass.setText("Password");
        label7Pass.setEchoChar((char) 0);
        label7Pass.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (new String(label7Pass.getPassword()).equals("Password")) {
        ...
        label8Text.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent event){
                if (label8Text.getText().equals("Mobile")) {
                    label8Text.setText("");
                }
            }
        ...
        //back to logIn
        backLogIn = new JButton("Already have an account? Log In");
        ...
        signUpButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               ...
               //executing restrictions
                Agent agent = new Agent (label1Text.getText(), label2Text.getText(), label3Text.getText(), gender, Date, Month, Year, label6Text.getText(), new String(label7Pass.getPassword()), label8Text.getText());
                Validation v = new Validation();
                String error = v.errorMsg(agent);
                if (error != null) {
                    ...
                    //database connection
                    try {
                        String query = "INSERT INTO agent_info values('" + label1Text.getText() + "','" + label2Text.getText() + "','" + label3Text.getText() + "','" +
                                gender + "','" + dob + "','" + label6Text.getText() + "','" + new String(label7Pass.getPassword()) + "','" + label8Text.getText() + "')";

                        String query2 = "INSERT INTO agentAccount values('" + label8Text.getText() + "', '" + 0 + "')";
                        String query3 = "create table " + label8Text.getText() + "trans (INCOMING VARCHAR(20), OUTGOING VARCHAR(20), MOBILE VARCHAR(15), DATE VARCHAR(50), AMOUNT DOUBLE)";
                        ...
                        String query1 = "SELECT * FROM agent_info WHERE MOBILE = '" + label8Text.getText() + "'";
