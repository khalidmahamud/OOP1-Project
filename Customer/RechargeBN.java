...
public class RechargeBN extends JFrame {
    ...
    public RechargeBN(String mobile) {
        ...
        amountMSG.setBounds(250,140,300,25);
        ...
        nextButton.setBounds(130,170,120,35);
        ...
        nextButton1.setBounds(130,250,120,35);
        ...
        nextButton2.setBounds(135,250,120,35);
            ...
            public void actionPerformed(ActionEvent e) {
                    if(Double.parseDouble(amountText.getText()) <= balance && isDigit(amountText.getText()))
                    {
                        if(password.equals(new String(addMonPass.getPassword())) )
                        {
                             ...
                             confirmRechargeBN confirm = new confirmRechargeBN(mobile, newBalance, addText.getText(), Double.parseDouble(amountText.getText()));
                             setVisible(false);
