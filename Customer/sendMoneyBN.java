...
public class sendMoneyBN extends JFrame {
    ...
    sendMoneyBN(String mobile) {
        ...
        recipientIcon = new JLabel(new ImageIcon("Pictures\\recipient.png"));
        ...
        nextButton1.setBounds(135, 225, 120, 35);
        ...
        recipientPassIcon = new JLabel(new ImageIcon("Pictures\\password.png"));
        ...
        nextButton2.setBounds(135, 225, 120, 35);
        ...
        nextButton1.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                ...
                if (error != null) {
                    ...
                    JOptionPane.showOptionDialog(null, "Invalid Mobile!", "Warning", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[]{}, null);
                }
                else {
        ...
        nextButton2.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                    if(password.equals(new String(recipientPass.getPassword())))
                    {
                        ...
                        confirmTransBN confirm = new confirmTransBN(mobile, newBalance, recipientText.getText(), Double.parseDouble(amountText.getText()));
                        setVisible(false);
        ...
        button4.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {       
                ...
                ProfilePageBN profile = new ProfilePageBN(mobile);
...
//              setVisible(false);
        ...
        backButton.addActionListener(new ActionListener () {
            public void actionPerformed(ActionEvent e) {
                HomePageBN send = new HomePageBN(mobile);
