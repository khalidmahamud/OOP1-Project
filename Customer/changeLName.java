...
public class changeLName extends JFrame { 
    ...
    public changeLName(String mobile) {
        ...
        submitButton.addActionListener(new ActionListener() {  
            ...
            if (error != null) {
                ...
                String query1 = "UPDATE user_info SET LASTNAME = '" + label2Text.getText() + "' WHERE MOBILE = '" + mobile + "'" ;
                try {
        ...
        backButton.addActionListener(new ActionListener () {
            public void actionPerformed (ActionEvent e) {
                dispose();
                //setVisible(false);
                ProfilePageEdit profile =  new ProfilePageEdit(mobile);
