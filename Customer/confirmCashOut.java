...
public class confirmCashOut extends JFrame {
    ...
    public confirmCashOut (String mobile, double newBalance, String recMobile, double amount) {
        this.mobile = mobile;
        ...
        recipientLabel = new JLabel("Agent");
